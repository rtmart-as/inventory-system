 ...
 * All rights reserved.
 */
package com.ychs.web.purchase_apply.mapper;
...
public interface PurchaseApplyMapper extends BaseMapper<PurchaseApply> {
    IPage<PurchaseApply> getList(IPage<PurchaseApply> page, @Param("supplierName") String supplierName, @Param(
            "goodsName") String goodsName);
    //减库存
    void subStock(@Param("parm") StockApplyParm parm);
}
